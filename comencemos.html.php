<?php require_once("header.html.php"); ?>
	<div id="contenedor-comencemos">
		...
		<div id="contenedor">
			...
			<div id="simple-collage">
				<div class="ver-ejemplos"><div style="height: 10px"></div>Ver ejemplos</div>
				<a href="javascript: nueva_orden('simple')"><img src="img/elegir-simple.jpg"></a>
				<a href="javascript: nueva_orden('collage')"><img src="img/elegir-collage.jpg"></a>
				<div class="ver-ejemplos" style="top: 238px; left: 343px"><div style="height: 10px"></div>Ver ejemplos</div>
			</div>

			<div id="multiple">
				<div class="ver-ejemplos"><div style="height: 10px"></div>Ver ejemplos</div>
				<a href="javascript: nueva_orden('multiple')"><img src="img/multiple.jpg"></a>
				<div class="ver-ejemplos" style="top: 238px; left: 343px"><div style="height: 10px"></div>Ver ejemplos</div>
			</div>
		</div>
		<!-- FIN CONTENIDO -->
